---
title: "The Real Cost Per Move-In (And Why Most Operators Don't Know Theirs)"
slug: cost-per-movein-math
date: 2026-03-10
pillar: operator-math
description: "Most self-storage operators know their cost per lead. Almost none know their true cost per move-in. Here's how to calculate it."
author: "Blake"
tags: [unit-economics, attribution, move-ins]
featured: true
draft: false
heroAlt: "Calculator on a desk with storage facility in background"
---
...
1. **Which leads came from which campaign** (not just "Google" vs "Facebook": which specific ad, which audience)
2. **Which of those leads became phone calls or form fills** (and which were spam, duplicates, or tire-kickers)
3. **Which qualified leads actually toured** (if you do tours)
4. **Which tours converted to signed leases**
5. **Which signed leases actually moved in** (yes, there's falloff here too)
...
1. **Use unique phone numbers per campaign**: even a basic call tracking service gives you source attribution
2. **Tag your leads in your management software**: SiteLink, storEDGE, whatever you use. Add a field for lead source.
3. **Review move-ins monthly against ad spend**: pull your move-in report, match it against your tagged leads, divide by spend
