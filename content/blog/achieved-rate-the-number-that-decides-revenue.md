---
title: "Achieved Rate: The Number That Quietly Decides Your Revenue"
...
featured: false
draft: false
heroAlt: "A revenue chart where occupancy is flat but achieved rate per unit rises"
---
...
**Discounting to compete instead of competing on being found.** When you can't win the click on presence, you win it on price, and every dollar you cut off the web rate is a dollar off achieved rate forever. We wrote about how [the gap between your web and street rate signals your pricing power](/blog/web-rate-street-rate-spread-signal). A wide gap you're forced into is achieved rate leaking out.

## The lever the REITs run and you mostly don't

The REIT playbook has three pricing moves: dynamic street rates, existing-customer increases, and achieved-rate management, the deliberate work of closing the gap between new and long-term rates. Independents who run a [systematic, sensible increase program](/blog/managing-occupancy-through-rate-increase) close 3 to 5 points of the occupancy-equivalent revenue gap without adding a single unit. That's revenue from units you already filled.

A word of caution, because the ground is shifting: this is exactly the area regulators are watching. California capped annual increases, [New York is in court with Extra Space](/blog/extra-space-nyc-lawsuit-means), and [the aggressive-increase playbook is closing](/blog/sb709-ecri-playbook-ending). So the move isn't to crank rates on captive tenants. It's to stop leaking achieved rate in the first place: quote smart, step teaser rates up reasonably and with disclosure, and don't discount yourself into a hole to win clicks you could win on presence.
...
Want to see how your rates stack up against the facilities nearby? [Run the free audit](/audit-tool). It takes about two minutes.
