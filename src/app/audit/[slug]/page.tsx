      ...
      {categories.map((cat) => {
        ...
        return (
          <a
            key={cat.slug}
            href={`#${cat.slug}`}
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium border transition-colors hover:bg-white/5 ${colors.border} ${colors.text}`}
          >
    ...
    <div className="min-h-screen bg-[var(--bg-void)] text-[var(--text-primary)]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        {industryBenchmarks && industryBenchmarks.length > 0 && (
          <div className="rounded-2xl border border-white/[0.06] bg-[var(--bg-elevated)] overflow-hidden mb-8">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/[0.06] bg-[var(--bg-primary)]/50">
        ...
        {ninetyDayProjection && ninetyDayProjection.ifYouAct && ninetyDayProjection.ifYouDont && (
          <div className="rounded-2xl border border-white/[0.06] overflow-hidden mb-8">
            <div className="px-6 py-4 border-b border-white/[0.06] bg-[var(--bg-elevated)]">
              <div className="flex items-center gap-2">
        ...
        {sortedCategories.some(c => typeof c.inactionCost === "number" && c.inactionCost > 0) && (
          <div className="rounded-2xl border border-white/[0.06] bg-[var(--bg-elevated)] p-6 mb-8">
            <div className="flex items-center gap-2 mb-4">
          ...
          <div className="bg-gradient-to-r from-[var(--accent)]/10 to-blue-600/5 px-6 py-5 border-t border-[var(--accent)]/10">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                <Link
                  href="/"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-white/10 text-sm text-[var(--text-secondary)] font-medium hover:bg-white/5 transition-colors"
                >
                  Learn More
                </Link>
              </div>
