    ...
    return (
      <div className="w-[320px] rounded-xl overflow-hidden shadow-2xl flex-shrink-0 bg-[var(--bg-elevated)]">
        ...
        <div className="px-3 pb-3">
          ...
          {description && (
            <p className="text-[10px] text-[var(--color-mid-gray)] mt-1">{description}</p>
          )}
          <div className="mt-2">
            <span className="inline-block bg-[var(--color-gold)] text-[var(--color-light)] text-[10px] font-semibold px-3 py-1 rounded">
              {cta}
            </span>
          </div>
        </div>
    ...
    return (
      <div className="w-[400px] rounded-xl overflow-hidden shadow-2xl flex-shrink-0 bg-[var(--bg-elevated)]">
        ...
        <div className="px-3 pb-2">
          <p className="text-sm text-[var(--color-dark)]">{primaryText}</p>
        </div>
        {/* Image */}
      ...
      <div className="w-[300px] border border-[var(--border-subtle)] rounded-lg overflow-hidden shadow-2xl flex-shrink-0 bg-[var(--bg-elevated)]">
        ...
        <div className="p-3 space-y-1.5">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <button className="bg-[var(--color-gold)] text-[var(--color-light)] text-[10px] font-semibold px-3 py-1 rounded">
              {cta}
            </button>
          </div>
        </div>
